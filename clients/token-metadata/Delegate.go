...
func (inst Delegate) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: ag_binary.TypeIDFromUint8(Instruction_Delegate),
	}}
}
...
func (inst *Delegate) Validate() error {
	...
	// Check whether all (required) accounts are set:
	{
		...
		// [11] = SplTokenProgram is optional

		// [12] = AuthorizationRulesProgram is optional

		// [13] = AuthorizationRules is optional
