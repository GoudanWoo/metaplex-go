...
// GetEditionTokenRecordAccount gets the "editionTokenRecord" account (optional).
// Token record account
...
func (inst Print) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: ag_binary.TypeIDFromUint8(Instruction_Print),
	}}
}
...
func (inst *Print) Validate() error {
	...
	// Check whether all (required) accounts are set:
	{
		...
		// [6] = EditionTokenRecord is optional
