...
// GetCollectionMintAccount gets the "collectionMint" account (optional).
// Mint of the Collection
...
// GetCollectionMasterEditionAccount gets the "collectionMasterEdition" account (optional).
// Master Edition Account of the Collection Token
...
func (inst Verify) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: ag_binary.TypeIDFromUint8(Instruction_Verify),
	}}
}
...
func (inst *Verify) Validate() error {
	...
	// Check whether all (required) accounts are set:
	{
		...
		// [3] = CollectionMint is optional

		// [4] = CollectionMetadata is optional

		// [5] = CollectionMasterEdition is optional
