...
// GetTokenOwnerAccount gets the "tokenOwner" account (optional).
// Owner of the token account
...
func (inst Mint) Build() *Instruction {
	return &Instruction{BaseVariant: ag_binary.BaseVariant{
		Impl:   inst,
		TypeID: ag_binary.TypeIDFromUint8(Instruction_Mint),
	}}
}
...
func (inst *Mint) Validate() error {
	...
	// Check whether all (required) accounts are set:
	{
		...
		// [1] = TokenOwner is optional

		if inst.AccountMetaSlice[2] == nil {
			return errors.New("accounts.Metadata is not set")
		}

		// [3] = MasterEdition is optional

		// [4] = TokenRecord is optional
		...
		// [13] = AuthorizationRulesProgram is optional

		// [14] = AuthorizationRules is optional
